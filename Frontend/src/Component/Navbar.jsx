...
function Navbar() {
  ...
  return (
    <>
      ...
      >
        <div
          className={`navbar bg-base-100  rounded-md dark:bg-slate-900 dark:text-white  ${
            sticky
        ...
        >
          ...
          <div className="navbar-end ">
            ...
            <div className=" hidden form-control outline-none md:block">
              <input
                className="border px-3 py-2 rounded-md outline-none"
                type="text"
                placeholder="Search"
                //   className=" bordered-none  w-24 md:w-auto"
              />
            </div>
            ...
            <div className="  ">
              <a
                className="btn bg-black text-white rounded-lg hover:bg-slate-800 duration-300 cursor-pointer "
                onClick={() =>
